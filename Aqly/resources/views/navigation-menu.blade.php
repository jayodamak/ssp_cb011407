        ...
        <div class="row">
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    ...
                    <a href="/dashboard" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><p id="aa">Hi, {{Auth::user()->name}}</p></a>
