                ...
                <form method="post"
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <input id="name" name="name" type="text" rows="3"
                        ...
                        <div class="col-span-full">
                            <label for="role" class="block text-sm font-medium leading-6 text-gray-900">Roll</label>

                            <div class="mt-2">

                                <select id="role" name="role" id="role" name="role" type="text" rows="3"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <p class="mt-3 text-sm leading-6 text-gray-600">Role of the user.</p>
